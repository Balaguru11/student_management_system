...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2021 at 07:21 AM
...
INSERT INTO `school_role` (`role_id`, `role_name`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
ALTER TABLE `school_class_subjects`
  MODIFY `class_sub_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `school_add_school`
  ADD CONSTRAINT `SCHOOL - LOGIN` FOREIGN KEY (`school_id`) REFERENCES `school_main_login` (`school_id`);

--
-- Constraints for table `school_class_subjects`
--
ALTER TABLE `school_class_subjects`
  ADD CONSTRAINT `classroom id links with classroom` FOREIGN KEY (`classroom_id`) REFERENCES `school_classroom` (`class_id`),
  ADD CONSTRAINT `staff_id links with class_subjecrt` FOREIGN KEY (`staff_id_assigned`) REFERENCES `school_staff` (`id`),
  ADD CONSTRAINT `subject links with class_subject` FOREIGN KEY (`subject_id`) REFERENCES `school_subjects` (`subject_id`);
...
ALTER TABLE `school_staff_salary`
  ...
  ADD CONSTRAINT `staff role links role table` FOREIGN KEY (`staff_role`) REFERENCES `school_role` (`role_id`);
